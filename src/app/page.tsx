            ...
            >
              ...
              <div className="flex gap-6">
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="px-8 py-3 bg-gradient-to-r from-red-600 to-purple-600 rounded-full font-bold hover:from-red-700 hover:to-purple-700 shadow-lg hover:shadow-red-500/30 transition-all duration-300 cursor-pointer"
                >
                  View Projects
                </motion.a>
                <motion.a
                  ...
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="px-8 py-3 border-2 border-red-500 rounded-full font-bold hover:bg-red-500/10 transition-all duration-300 cursor-pointer"
                >
                  Contact Me
                </motion.a>
              </div>
